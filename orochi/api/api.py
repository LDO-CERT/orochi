...
from orochi.api.routers.playbooks import router as playbooks_router
...
from orochi.api.routers.tasks import router as tasks_router
...
api.add_router("/playbooks/", playbooks_router, tags=["Playbooks"])
